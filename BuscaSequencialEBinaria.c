...
int binariaIterativa(int vetor[], int valor){
    ...
    while (inicio<=fim){ //condição inicial.

       int meio = (inicio+fim)/2; // calculo da posição correspondente ao meio do vetor
...
//busca o elemento no vetor de forma recursiva. A cada iteração a função reduz o espaço de busca.
     ...
     do{
        ...
        switch(opcao)
        {
            ...
            case 1:
                    ...
                    //BUSCA SEQUENCIAL
                    // busca sequencialmente o item dentro do vetor com base em comparação.
                    ...
                    {
                    system("cls||clear");
                    printf ("Valor %d esta na posicao %d\n", valor, resp[i]);   // Percorre as posições; // Percorre as posições
                                                                               // No médio caso: o elemento é encontrado após (N+1)/2  comparações;
                                                                              // No pior caso: o elemento é encontrado na ultima posição após fazer comparação com todos os itens do vetor.
                                                                             // No melhor caso: o elemento procurado é encontrado na primeira tentativa;

                    }
                        }
                    else {
                            printf("\n Numero nao encontrado"); // O elemento não é encontrado após percorrer todo o vetor.
                        }
                        while( (getchar()) != '\n');
                        getchar();
                    system("cls||clear");
